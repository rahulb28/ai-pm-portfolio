...
"""
    ...
    DAILY_COST_LIMIT      = 0.10                 # hard stop at $0.10/day
    total_cost            = 0.0
    ...
    while iteration < max_iterations:
        ...
        # ── Extract HTML first (before cost check — don't discard a finished brief) ──
        ...
        if total_cost >= DAILY_COST_LIMIT:
            ...
            if html_body:
                print("  ✅ HTML was already extracted — will send the brief.")
            break
        # ──────────────────────────────────────────────────────────────────────
